														...
														<tr>
															...
															<td  style="text-align: center;">
																<div class="hidden-sm hidden-xs btn-group">
																	<form class="pull-left" method="get" action="/admin/news/{{$v->id}}">
																		{{csrf_field()}}	
																	...
																	<form class="pull-left" method="get" action="/admin/news/{{$v->id}}/edit">
																	...
																	<form action="/admin/news/{{$v->id}}" method="post" class="pull-left del">
																		{{method_field('DELETE')}}
																		{{csrf_field()}}
