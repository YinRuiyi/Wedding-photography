				...
				<div class="col-xs-12">
					<div class="step-content pos-rel" id="step-container">
						<div class="step-pane active" id="step1">
							@foreach($news as $k => $v)
							<h3 class="lighter block blue">请修改 {{$v->newsname}} 的信息</h3>
							<table style="position: relative;width: 100%;" class="table table-bordered table-hover table-striped">
								<form method="post" action="/admin/news/{{$v->id}}" enctype="multipart/form-data">
								<tr>
								...
								<tr>
									...
									<td>
										<input type="text" value="{{$v->newsname}}" name="newsname" id="newsname" style="border: none; width: 100%; height: 100%; background-color: transparent;">
									</td>
								</tr>
								<tr>
									<td class="col-md-4 text-center">状态</td>
									<td>
