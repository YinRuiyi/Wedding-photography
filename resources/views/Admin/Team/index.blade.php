@extends('Admin.index')@section('topjs')
<style type="text/css">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
														...
														<tr>
															...
															<td>
																<img style="max-width: 690px; max-height: 300px;" src="{{$v->photo}}" alt="图片丢失" style="width: 100px; height: 100px;">
															</td>
															...
															<td  style="line-height: 300px; text-align: center;" class="hidden-480">
																...
																@else
																	<span class="label label-success arrowed">{{$v->status}}号</span>
																@endif
															</td>
															<td  style="line-height: 300px; text-align: center;">
																<div class="hidden-sm hidden-xs btn-group">
																	<form class="pull-left" method="get" action="/admin/team/{{$v->id}}">
																		{{csrf_field()}}	
																	...
																	<form class="pull-left" method="get" action="/admin/team/{{$v->id}}/edit">
																	...
																	<form action="/admin/team/{{$v->id}}" method="post" class="pull-left del">
																		{{method_field('DELETE')}}
																		{{csrf_field()}}
